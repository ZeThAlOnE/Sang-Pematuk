...
class GoldenEye(object):
    ...
    def exit(self):
        self.stats()
        print "\033[31mTurns off Shooting2"
    ...
    def printHeader(self):
        ...
        print "\033[31mHead Shot"

    def fire(self):

        self.printHeader()
        print "\033[32mShooting servers. Not Shooting girls".format(self.method, self.nr_workers, self.nr_sockets)

        if DEBUG:
            print "\033[32mStart shooting brutally".format(self.nr_workers)
        ...
        for i in range(int(self.nr_workers)):
            ...
            try:
                ...
                error("\033[31mFailed to shoot".format(i))
                pass 
    ...
    def monitor(self):
        while len(self.workersQueue) > 0:
            try:
                ...
                print "\033[31mCTRL+C Accepted shooting"
                for worker in self.workersQueue:
                    try:
                        if DEBUG:
                            print "\03[31mKilling servers".format(worker.name)
                        worker.stop()
                    except Exception, ex:
                        pass
                if DEBUG:
...
class Laser(Process):
    ...
    def run(self):
        ...
        if DEBUG:
            print "\033[32mStart Shooting".format(self.name)
        ...
        if DEBUG:
            print "\033[36mMission completed. The shooter is sleeping".format(self.name)
...
def usage():
    print
    print '\033[32m______________________________________________________________'
    print ' USAGE: ./Shooting1.py <url> [OPTIONS]'
    print
    print ' OPTIONS:'
    ...
    print '\033[31m_____________________________________________________________'
